...
public class MqttConfiguration {
    ...
    // 激活查询topic
    public static final String TOPIC_ACTIVE_QUERY = "active_query/#";
    // 激活查询结果topic
    public static final String TOPIC_ACTIVE_QUERY_RESULT = "active_query_result/#";
    // 设备统计
    public static final String TOPIC_DEVICE_STATISTICS = "device_statistics/#";
