...
public class WechatUtils {
    ...
    private static final String appId = "wx2226085421777f2f";
    private static final String appSecret = "ea5cc61ed01748e43511683006db59e9";
     ...
     * @return
     */
    public static JSONObject authCode2Session(String jsCode) {
        ...
        LoggerUtils.info("api/wx-mini/getSessionKey:" + str);
